...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VoIP Support Pro — NetSapiens Support & Consulting" },
      { name: "description", content: "Expert NetSapiens / SNAPsolution support, setup, and consulting for telecom service providers, MSPs, and resellers." },
      { name: "author", content: "VoIP Support Pro" },
